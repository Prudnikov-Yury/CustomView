...
class BottomButtonsView(
    ...
    private fun initializeAttributes(attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        with(binding) {
            ...
            val bottomPositiveBackgroundColor = typedArray.getColor(
                R.styleable.BottomButtonsView_bottomPositiveBackgroundColor,
                Color.BLACK
            )
            binding.positiveButton.backgroundTintList =
                ColorStateList.valueOf(bottomPositiveBackgroundColor)
            ...
            binding.negativeButton.backgroundTintList =
                ColorStateList.valueOf(bottomNegativeBackgroundColor)
